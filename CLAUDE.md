...
cargo run -p gs-cli -- add <video.mp4> [--project <dir>]  # ingest a video (creates ./gs-project on first use); the ONLY ingestion command — add order doesn't matter
